  ...
  extends Service
{
  ...
  static
  {
    try
    {
      logger = Logger.getLogger("co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagementService");
      URL baseUrl =
  ...
  public co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagement getLDAPAuthenticationManagementPort()
  {
    return (co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagement) super.getPort(new QName("http://ws.ldap.marketplace.losalpes.com.co/",
                                                                                                   "LDAPAuthenticationManagementPort"),
                                                                                         co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagement.class);
  }

  @WebEndpoint(name="LDAPAuthenticationManagementPort")
  public co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagement getLDAPAuthenticationManagementPort(WebServiceFeature... features)
  {
    return (co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagement) super.getPort(new QName("http://ws.ldap.marketplace.losalpes.com.co/",
                                                                                                   "LDAPAuthenticationManagementPort"),
                                                                                         co.com.losalpes.marketplace.ldap.LDAPAuthenticationManagement.class,
