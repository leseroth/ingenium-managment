...
import portlets.resource.OrdenCompraDirectaBundle;

public class OrdenCompraDirecta extends GenericPortlet {
    ...
    protected void doDispatch(RenderRequest request,
        ...
        if (contentType.equals("text/html")) {
            if (mode.equals(PortletMode.VIEW)) {
                rd = context.getRequestDispatcher("/OrdenCompraDirecta/html/view.jsp");
            } else {
                super.doDispatch(request,response);
            }
        } else {
