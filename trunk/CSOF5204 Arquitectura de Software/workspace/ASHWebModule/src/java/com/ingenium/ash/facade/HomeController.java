...
import com.ingenium.ash.bean.HomeFacade;
...
public class HomeController {
    ...
    @EJB private com.ingenium.ash.bean.HomeFacade ejbFacade;
    ...
    public static class HomeControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Home) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+HomeController.class.getName());
            }
        }
