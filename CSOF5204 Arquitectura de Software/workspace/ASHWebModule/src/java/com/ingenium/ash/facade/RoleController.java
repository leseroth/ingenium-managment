...
public class RoleController {
    ...
    @EJB private com.ingenium.ash.bean.RoleFacade ejbFacade;
    ...
    public static class RoleControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Role) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+RoleController.class.getName());
            }
        }
