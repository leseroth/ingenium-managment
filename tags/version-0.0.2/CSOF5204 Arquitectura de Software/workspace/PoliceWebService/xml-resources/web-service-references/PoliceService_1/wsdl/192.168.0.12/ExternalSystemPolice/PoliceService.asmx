...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/ExternalSystemPolice/PoliceService.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">PoliceService</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="PoliceService.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="PoliceService.asmx?op=HelloWorld">HelloWorld</a>
              ...
              <li>
                <a href="PoliceService.asmx?op=NotifyEvent">NotifyEvent</a>
